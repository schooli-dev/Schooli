...
export type TeacherAccessSummary = {
  id: string;
  fullName: string;
  email: string;
  timezone: string;
...
export type TeacherModuleAccess = {
...
export class LearningMaterialsApiService {
  ...
  listTeacherAccess(): Observable<ApiResponse<TeacherAccessSummary[]>> {
    return this.api.get('/learning-materials/teacher-access');
  }

  getTeacherModules(teacherId: string): Observable<ApiResponse<TeacherModuleAccess>> {
    return this.api.get(`/learning-materials/teachers/${teacherId}/modules`);
  }

  replaceTeacherModules(teacherId: string, moduleIds: string[]): Observable<ApiResponse<TeacherModuleAccess>> {
    return this.api.put(`/learning-materials/teachers/${teacherId}/modules`, { moduleIds });
  }
