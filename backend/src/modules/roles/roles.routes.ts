...
import { createRoleSchema, deleteRoleSchema, updateRoleSchema } from "./roles.validation.js";
...
rolesRoutes.delete("/:id", authMiddleware, requirePermission("settings.update"), validate(deleteRoleSchema), rolesController.deleteRole);
